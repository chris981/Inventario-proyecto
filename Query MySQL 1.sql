...
if p_modo='I'
then
insert into Tabla_Usuarios values (p_nom_emp,p_ape_emp,p_tip_usu,p_usu_emp,p_con_usu);
end if;
-- Actualizacion
if p_modo='A'
then
update Tabla_Usuarios set nom_emp=p_nom_emp,ape_emp=p_ape_emp,tip_usu=p_tip_usu,usu_emp=p_usu_emp,con_usu=p_con_usu
where nom_emp=p_nom_emp;
end if;
-- Eliminacion
if p_modo='E'
