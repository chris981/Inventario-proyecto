...
if @modo='I'
begin
insert into Tabla_Usuarios values (@nom_emp,@ape_emp,@res_emp,@hor_emp,@usu_emp,@con_usu)
end
--Actualizacion
if @modo='A'
begin
update Tabla_Usuarios set nom_emp=@nom_emp,ape_emp=@ape_emp,res_emp=@res_emp,hor_emp=@hor_emp,usu_emp=@usu_emp,con_usu=@con_usu
where nom_emp=@nom_emp
end
--Eliminacion
if @modo='E'
