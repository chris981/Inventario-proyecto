...
<body>
    ...
    try {
        $query = "CALL SP_ControlFrituras($codigoFritura,'$cantidadFritura','$codigoempleado','$horarioFritura','$cambioRBD','$codigoempcambio','$codigofre')";
        $resultado = $mysqli->query($query);
        switch ($Tipo_Accion) {
            case "I":
    ?>
                <h2>Cambio agregado de RBD!</h2>
                <a href="../Formularios/ControlRBDFrituras.php">
