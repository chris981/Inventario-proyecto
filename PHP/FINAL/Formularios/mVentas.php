...
<body>
    <div class="w3-bar w3-orange">
        ...
        <a class="w3_bar-item w3-button w3-hide-small" href="#">Inventario</a>
        ...
        <div id="demo" class="w3-bar-block w3-orange w3-hide w3-hide-large w3-hide-medium">
                ...
                <a class="w3-bar-item w3-button" href="#">Inventario</a>
            ...
            <div class="w3-container w3-cell w3-border">
                <table class=" w3-table">
                    <tr>
                        ...
                        <td><b>Factura:</b></td>
                        <td>
                            <input class="w3-input w3-border" type="text" name="factura" value="<?php echo $factura; ?>">
