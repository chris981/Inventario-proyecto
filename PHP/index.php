...
<body>
<form action="Funciones/login.php" class="w3-container w3-card-4 w3-light-grey w3-text-orange w3-margin " style="width:600px " method="post">

<center ><img src="Recursos/logo.png" width="30%" class="w3-margin-top" /></center>
<h2 class="w3-center">Sistema de Inventario de Pollo Landia</h2>
