...
if p_modo='I'
then
insert into Tabla_Control_Frituras values (p_cant_fri,p_cod_emp,p_hor_fri,p_cam_rbd,p_cod_emp_cam,p_cod_fre);
end if;
-- Actualizacion
if p_modo='A'
then
...
if p_modo='I'
then
insert into Tabla_Suministros values (p_nom_sum,p_tip_sum,p_cant_inv,p_elab_sum,p_venc_sum,p_rec_sum,p_cod_emp);
end if;
-- Actualizacion
if p_modo='A'
then
...
if p_modo='I'
then
insert into Tabla_Ventas values (p_fech_venta,p_cod_emp,p_cant_vend,p_tot_venta);
end if;
-- Actualizacion
if p_modo='A'
then
...
if p_modo='I'
then
insert into Detalle_ventas values (p_cod_sum,p_cod_menu);
end if;
-- Actualizacion
if p_modo='A'
then
...
if p_modo='I'
then
insert into Tabla_Solicitud_Pedidos values (p_nom_sum,p_fecha,p_tip_sum,p_cant_soli,p_cod_emp);
end if;
-- Actualizacion
if p_modo='A'
then
...
if p_modo='I'
then
insert into Tabla_Recepcion_Pedidos values (p_fecha,p_cant_reci,p_cod_emp,p_tot_gasto);
end if;
-- Actualizacion
if p_modo='A'
then
...
if p_modo='I'
then
insert into Tabla_Registro_Compras values (p_nom_art,p_fecha,p_tot_gast,p_cod_emp);
end if;
-- Actualizacion
if p_modo='A'
then
...
if p_modo='I'
then
insert into Tabla_Freidoras values (p_info_fre);
end if;
-- Actualizacion
if p_modo='A'
then
...
if p_modo='I'
then
insert into Tipo_Suministros values (p_nom_sum);
end if;
-- Actualizacion
if p_modo='A'
then
