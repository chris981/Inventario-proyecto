...
create proc SP_ControlEmpleados
(
@Num_Emp int,
@Nom_Emp varchar (30),
@Ape_Emp varchar (30),
...
if @modo='I'
begin
insert into control_Empleados values (@Num_Emp,@Nom_Emp,@Ape_Emp,@Telefono,@Direccion,@horario,@contra)
end
--Actualizacion
if @modo='A'
begin
update control_Empleados set Num_emp=@Num_Emp,Nom_Emp=@Nom_Emp,Ape_Emp=@Ape_Emp,Telefono=@Telefono,Direccion=@Direccion,horario=@horario,contra=@contra 
where Num_Emp=@Num_Emp
end
--Eliminacion
if @modo='E'
begin 
delete from control_Empleados
where Num_Emp=@Num_Emp
end
go

--Inserta
exec SP_ControlEmpleados 01, 'Gerardo','Elvir','9820-9812','Col. Hato','AM', 'Honduras123','I'

--Actualiza
exec SP_ControlEmpleados 01, 'Gerardo','Elvir','9820-9812','Col. Suyapa','AM', 'Honduras123','A'

--Elimina
exec SP_ControlEmpleados 01, 'Gerardo','Elvir','9820-9812','Col. Suyapa','AM', 'Honduras123','E'
